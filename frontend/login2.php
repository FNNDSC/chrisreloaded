...
function testTemplateClass() {
	...
	$t = new Template('login2.html');
	$t -> replace('TITLE', "<title>ChRIS 2 -Reloaded</title>");
	$t -> replace('STYLE', 'style.html');
	$t -> replace('NAVBAR', 'navbar2.html');
	$t -> replace('NAVLIST', 'navlist2.html');
	$t -> replace('RESULTS', 'quickresults.html');
	$t -> replace('IMAGES', 'quickimages.html');
	$t -> replace('PIPELINES', 'quickpipelines.html');
