...
{$('.appriseInner').append('<div class="aInput"><input type="text" class="aTextbox" t="aTextbox" style="font-size:11px" value="'+args['input']+'" /></div>');}
else
{$('.appriseInner').append('<div class="aInput"><input type="text" class="aTextbox" t="aTextbox" style="font-size:11px" /></div>');}
$('.aTextbox').focus();}}
...
{aText = $('.aTextbox').val();$('.appriseOverlay').remove();$('.appriseOuter').remove();if(callback)
