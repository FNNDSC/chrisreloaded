 ...
 * The data is organized by: username/pluginname/feedid
 */
define('CLUSTER_CHRIS_USERS', joinPaths('/SCRATCH4/cubic/chris', 'users'));
/**
 ...
 */
define('CLUSTER_CHRIS_BIN', joinPaths('/SCRATCH4/cubic/chris', 'bin'));
define('CLUSTER_CHRIS_LIB', joinPaths('/SCRATCH4/cubic/chris', 'lib'));
/**
 ...
 */
 define('CHRIS_ENV_PYTHONPATH', joinPaths('/SCRATCH4/cubic/chris/lib', 'py'));
